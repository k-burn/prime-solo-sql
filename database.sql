...
-- 3. The bank is giving a new customer bonus! Update all records with an account balance of 
...
-- 8. Add a new record.
INSERT INTO "accounts" ("username", "city", "transactions_completed", "transactions_attempted","account_balance") VALUES ('kara', 'Minneapolis', 1, 1, 10000000);
...
DELETE FROM "accounts" WHERE ("city" ILIKE 'Miami' AND "transactions_completed"<5) OR ("city" ILIKE 'Phoenix' AND "transactions_completed"<5);
